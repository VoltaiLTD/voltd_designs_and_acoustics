...
export const metadata = {
  ...
  description: "Premium ACP, WPC, CNC, and acoustic solutions: design, supply, installation, and noise control.",
};
        ...
        <header className="sticky top-0 z-50 bg-black/50 backdrop-blur border-b border-white/10">
          <div className="container flex items-center justify-between py-3">
            <Link href="/" className="flex items-center gap-2 font-bold">
              Volt <span style={{ color: "#D4AF37" }}>Designs</span> & Acoustics
            </Link>
